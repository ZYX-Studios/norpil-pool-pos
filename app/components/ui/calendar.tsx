    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                nav_button: cn(
                    "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border border-neutral-200 rounded flex items-center justify-center transition-opacity hover:bg-neutral-100 text-neutral-500"
                ),
                ...
                day_button: cn(
                    ...
                    "aria-selected:bg-neutral-900 aria-selected:text-neutral-50 dark:aria-selected:bg-neutral-50 dark:aria-selected:text-neutral-900"
                ),
                range_start: "day-range-start",
                range_end: "day-range-end",
                selected:
                    "bg-neutral-900 text-neutral-50 hover:bg-neutral-900 hover:text-neutral-50 focus:bg-neutral-900 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900",
